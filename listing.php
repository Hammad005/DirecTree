...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    ...
    ?>
    <!-- listing-hero -->
    <section id="listing-hero" class="d-flex align-items-center">
            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-lg-8 text-center pb-5 mt-5 ">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            <h1>Listing</h1>
                            <p>Your ultimate online guide to the best local spots and services. Whether you're a local
                                or just visiting, DirecTree helps you find exactly what you're looking for. From
                                delicious dining options and cozy hotels to shopping hotspots and fitness centers, we
                                cover it all. Discover top beauty salons, vibrant nightlife, fun activities, cultural
                                landmarks, and more. With DirecTree, finding the best of your city is easy and
                                straightforward. Start exploring now! Plus, you can add your own listings by clicking
                                the button below to help others find great spots too.</p>
                        </div>
                    </div>
                    <?php
                    if (isset($_GET['listingExist'])) {
                        ...
                        <div class="alert alert-success alert-dismissible fade show w-100 " role="alert"
                                    ...
                                    <strong>Alert!</strong> This listing already exists in this category.
                    ...
                    if (isset($_GET['listingAdded'])) {
                        ...
                        <div class="alert alert-success alert-dismissible fade show w-100 " role="alert"
                                    style="font-size:12px;">
                                    <strong>Submitted!</strong> Listing has been submitted. Please wait for the community to respond.
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" style="box-shadow:none;"></button>
                                    </div>';
                    } else if (!isset($_GET['listingAdded']) == false) {
                        echo '
                    ...
                    if (!isset($_SESSION['loggedin']) || $_SESSION == false) {
                        echo '
                            <div class="container text-center">
                                <p><b>Note:</b> Please sign in for add listing.</p>
                                <a href="sign-in/sign-in.php" class="btn btn-outline-light top-btn ">
                        ...
                        echo '
                            <div class="container text-center">
                                <a href="add_listing.php" class="btn btn-outline-light top-btn "><span class="ti-plus"></span>
                                    Add Listing</a>
                            </div>
                            ';
                    }
    ...
    <!-- listing-hero END -->
    <!-- listing cat Section -->
    <section id="listing-cat" class="ftco-section mb-0 bg-light">
        <div class="container-xl">
            <div class="row justify-content-center mb-5 mt-4">
                <div class="col-md-7 heading-section text-center aos-init aos-animate" data-aos="fade-up"
                    ...
                    <div class="styled-heading mb-3">
                        <h2>Let's Explore Your Awesome City</h2>
                    </div>
                </div>
            </div>
            <form method="GET" action="searchResults.php" class="search-property-1 mt-md-0">
            ...
            <div class="row justify-content-center mt-5">
                ...
                <div class="container">
                    <div class="row">
                        <!-- Image 1 -->
                        <div class="col-md-3 collage-item large">
                            <a href="food_drink.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/foods.jpg" class="img-fluid" alt="Food and Drink">
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                            ...
                                            <p><?php
                                                ...
                                                if ($count === 1) {
                                                    echo $formattedCount . " Listing";
                                                } else {
                                                    echo $formattedCount . " Listings";
                                                }
                                                ?></p>
                                        </figcaption>
                                    </figure>
                        ...
                        <!-- Image 2 -->
                        <div class="col-md-3 collage-item small ">
                            <a href="hotels.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/hotels.jpg" class="img-fluid" alt="Hotels" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <path d="M31.17 38.498h1.324v3.924h1.117v-3.924h1.348v-.918H31.17z">
                                                    </path>
                                                    <path
                            ...
                            <a href="shopping.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/shopping.jpg" class="img-fluid" alt="Shopping">
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-md-3 collage-item large">
                            <a href="beauty.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/beauty.jpg" class="img-fluid" alt="Beauty" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-md-3 collage-item small">
                            <a href="fitness.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/fitness.jpg" class="img-fluid" alt="Fitness" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    viewBox="0 0 216.61 216.61" xml:space="preserve">
                                                    <g>
                                                        <path
                            ...
                            <!-- Image 6 -->
                            <a href="hookah_bars.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/bars.jpg" class="img-fluid" alt="Bar & Club">
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-md-3 collage-item small">
                            <a href="games.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/game.jpg" class="img-fluid" alt="Games" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                            ...
                            <a href="places.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/places.jpg" class="img-fluid" alt="Places" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                                                    role="img" class="iconify iconify--gis"
                                                    preserveAspectRatio="xMidYMid meet">
                                                    <path
                        ...
                        <div class="col-md-3 collage-item large">
                            <a href="shows.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/circus.jpg" class="img-fluid" alt="Circus" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-md-3 collage-item small">
                            <a href="movie_theater.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/theater.jpg" class="img-fluid"
                                            alt="Movie Theaters" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                            ...
                            <a href="sports.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/sports.jpg" class="img-fluid" alt="Sports">
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
                                                <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-md-3 collage-item large">
                            <a href="health.php">
                                <div class="find-place-img_wrap">
                                    <figure class="effect-ruby">
                                        <img src="images/listing-cat/health.jpg" class="img-fluid" alt="Health" />
                                        <div class="overlay"></div>
                                        <figcaption>
                                            <h5>
    ...
    <!-- End listing cat Section -->
    <!-- Start New listing Section -->
    <section id="new_listing" class="ftco-section bg-light">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 heading-section text-center mb-3 mt-5" data-aos="fade-up" data-aos-duration="1000">
                    <span class="subheading">Listing</span>
                    <h2 class="mb-4">New Listings</h2>
                </div>
            </div>
            <div class="row justify-content-center">

                <?php
                $sql = "SELECT * FROM `listings` WHERE `status` = 'approved' ORDER BY `id` DESC LIMIT 4";
                $result = mysqli_query($conn, $sql);
