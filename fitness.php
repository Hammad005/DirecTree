...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    ...
    ?>
    <!-- Fitness-hero -->
    <section id="fitness-hero" class="d-flex align-items-center">
    ...
    <!-- Fitness-hero END -->
    <!-- Fitness Section -->
    <section id="fitness" class="ftco-section mb-0 bg-light">
        <div class="container-xl">
            <div class="row justify-content-center mb-5 mt-5">
                <div class="col-md-12 heading-section text-center" data-aos="fade-up" data-aos-duration="1000">
                    <h2>
                        Craving a workout boost<span>?</span>
                    </h2>
                    <span class="subheading">Find all your fitness needs here!</span>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row justify-content-center">
                ...
                $limit = 8;
                $offset = ($page - 1) * $limit;
                $sql = "SELECT * FROM `listings` WHERE `listing_cat` = 'Fitness' AND `status` = 'approved' ORDER BY `id` LIMIT $limit OFFSET $offset";
            ...
            $sql = "SELECT COUNT(*) AS total FROM `listings` WHERE `listing_cat` = 'Fitness' AND `status` = 'approved'";
