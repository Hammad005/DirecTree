            ...
            <div class="signin-content">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if ($num > 0) {
                        ...
                        $_SESSION['id'] = $row['id'];
                        header("location: ../index.php #silder");
                    } else {
                        $showError = true;
                    }
                }
                ...
                <div class="signin-form">
                    ...
                    <h2 class="form-title mt-2">Sign in</h2>
                    <?php
                    if ($showError) {
                    ...
                    ?>
                    <form action="../sign-in/sign-in.php" method="POST" class="register-form" id="login-form">
                    ...
                    <div class="signup-link">
                        <a href="sign-up.php" class="signup-btn-link">Create an account</a>
                    </div>
                    <div class="signup-link mt-0">
                        <a href="../index.php" class="signup-btn-link">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
