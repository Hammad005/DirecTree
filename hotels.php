...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    ...
    ?>
    <!-- Hotels-hero -->
    <section id="hotels-hero" class="d-flex align-items-center">
    ...
    <!-- Hotels-hero END -->
    <!-- Hotels Section -->
    <section id="hotels" class="ftco-section mb-0 bg-light">
        <div class="container-xl">
            <div class="row justify-content-center mb-5 mt-5">
                <div class="col-md-12 heading-section text-center" data-aos="fade-up" data-aos-duration="1000">
                    <h2>
                        Need a comfort<span>,</span> luxury<span>,</span> and the perfect place to stay<span>?</span>
                    </h2>
                    <span class="subheading">Find it here!</span>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <?php
                ...
                $limit = 8;
                $offset = ($page - 1) * $limit;
                $sql = "SELECT * FROM `listings` WHERE `listing_cat` = 'Hotels' AND `status` = 'approved' ORDER BY `id` LIMIT $limit OFFSET $offset";
            ...
            <?php
                ...
                $sql = "SELECT COUNT(*) AS total FROM `listings` WHERE `listing_cat` = 'Hotels' AND `status` = 'approved'";
