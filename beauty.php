...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    ...
    ?>
    <!-- Beauty-hero -->
    <section id="beauty-hero" class="d-flex align-items-center">
    ...
    <!-- Beauty-hero END -->
    <!-- Beauty Section -->
    <section id="beauty" class="ftco-section mb-0 bg-light">
        <div class="container-xl">
            <div class="row justify-content-center mb-5 mt-5">
                <div class="col-md-12 heading-section text-center" data-aos="fade-up" data-aos-duration="1000">
                    <h2>
                        Looking for top beauty shops<span>?</span>
                    </h2>
                    <span class="subheading">Discover them all here!</span>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <?php
                ...
                $limit = 8;
                $offset = ($page - 1) * $limit;
                $sql = "SELECT * FROM `listings` WHERE `listing_cat` = 'Beauty' AND `status` = 'approved' ORDER BY `id` LIMIT $limit OFFSET $offset";
            ...
            $sql = "SELECT COUNT(*) AS total FROM `listings` WHERE `listing_cat` = 'Beauty' AND `status` = 'approved'";
