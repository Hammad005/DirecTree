...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    ...
    ?>
    <!-- Hookah Bar-hero -->
    <section id="bar-hero" class="d-flex align-items-center">
    ...
    <section id="bar" class="ftco-section mb-0 bg-light">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                $limit = 8;
                $offset = ($page - 1) * $limit;
                $sql = "SELECT * FROM `listings` WHERE `listing_cat` = 'Hookah Bars' AND `status` = 'approved' ORDER BY `id` LIMIT $limit OFFSET $offset";
            ...
            $sql = "SELECT COUNT(*) AS total FROM `listings` WHERE `listing_cat` = 'Hookah Bars' AND `status` = 'approved'";
