            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Create New User Account</h6>
                            <form action="partials/_addUser.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" name="c_password" id="exampleInputPassword1" required>
                                </div>
