    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h3><i class="fas fa-plus-circle me-2"></i> Add Listing</h3>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Create New Listing</h6>
                            <form action="partials/_addListing.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="location" class="form-control" id="form-control" placeholder="Enter Listing location" required></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" name="addListing" class="btn btn-primary">Add Listing</button>
                            </form>
                        </div>
                    </div>
                </div>
